 ...
 */
goog.provide('lc.data.model.Base');
...
goog.require('lc.data.filter.Base');
...
*/
lc.data.model.Base = function(opt_json, opt_minified) {
    ...
    if(goog.isDef(opt_minified) && goog.isBoolean(opt_minified) && opt_minified && goog.isDefAndNotNull(opt_json)) {
        this.id_ = new prestans.types.String({value: opt_json[lc.data.model.Base.REWRITE_MAP["id"]], required: false, defaultValue: null, opt_maxLength: null, opt_minLength: null, format: null, choices: null, trim: true});
    }
...
goog.inherits(lc.data.model.Base, prestans.types.Model);

lc.data.model.Base.Meta = {
    Id: {
        REQUIRED: false,
        DEFAULT: null,
        MAX_LENGTH: null,
...
//Rewrite map
lc.data.model.Base.REWRITE_MAP = {
    "id": "a"
};

//Reverse rewrite map
lc.data.model.Base.REVERSE_REWRITE_MAP = {
    "a": "id"
};

lc.data.model.Base.prototype.getId = function() {
    return this.id_.getValue();
};

lc.data.model.Base.prototype.setId = function(value) {
...
lc.data.model.Base.prototype.setValueForKey = function(key, value) {
...
lc.data.model.Base.prototype.getValueForKey = function(key) {
...
lc.data.model.Base.prototype.clone = function(opt_filter) {
    var json_ = this.getJSONObject(false, opt_filter);
    return new lc.data.model.Base(json_, false);
};

/**
 * @param {boolean} minified
 * @param {lc.data.filter.Base=} opt_filter
 */
lc.data.model.Base.prototype.getJSONObject = function(minified, opt_filter) {

    //check that filter is of correct type
    if(goog.isDefAndNotNull(opt_filter) && !(opt_filter instanceof lc.data.filter.Base))
    ...
    if(goog.isDef(minified) && goog.isBoolean(minified) && minified) {
            ...
            jsonifiedObject_[lc.data.model.Base.REWRITE_MAP["id"]] = this.getId()
 ...
 * @param {lc.data.filter.Base=} opt_filter
 */
lc.data.model.Base.prototype.getJSONString = function(minified, opt_filter) {
